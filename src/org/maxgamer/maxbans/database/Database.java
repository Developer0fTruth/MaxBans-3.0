...
public class Database{
	...
	public Database(DatabaseCore core) throws ConnectionException{
		...
		this.core = core;
		this.watcher = new DatabaseWatcher(this);
	}
	
	public DatabaseWatcher getWatcher(){
		return watcher;
	}
	...
	/**
	 * Fetches the connection to this database for querying. Try to avoid doing this in the main thread.
	...
	/**
	 * Represents a connection error, generally when the server
	 * can't connect to MySQL or something.
	 */
	 ...
	 * settings. This may take a long time, and will print out
	 * progress reports to System.out
	 * 
	 * This method does not create the tables in the new database.
